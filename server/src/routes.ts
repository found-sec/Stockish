...
router.post("/api/auth/login", authController.login, verifySignUp.checkDuplicateEmail, verifySignUp.checkDuplicateUsername);

// Password reset route (forgot-password)
router.post('/api/auth/forgot-password', authController.forgotPassword, verifySignUp.checkDuplicateEmail, verifySignUp.checkDuplicateUsername);
